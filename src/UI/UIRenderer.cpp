...
void UIRenderer::Init() {
	...
	//UIWindowManager::GetSingleton().AddWindow();
...
void UIRenderer::Render() {
	...
	UIWindowManager::GetSingleton().Update();
...
//}
//
//void UIRenderer::ProcessInputEvents(const RE::InputEvent* const* a_events) {
//	if (a_events) {
...
//RE::TESObjectREFR* UIRenderer::GetRefrToEvaluate() {
...
//void UIRenderer::SetRefrToEvaluate(RE::TESObjectREFR* a_refr) {
//	_refrToEvaluate = a_refr;
//	AnimationLog::GetSingleton().ClearAnimationLog();
//}

//bool UIRenderer::ShouldConsumeInput() const {
//	return _menusConsumingInput > 0;
//}

//void UIRenderer::AddInputConsumer() {
...
//void UIRenderer::RemoveInputConsumer() {
//	if (--_menusConsumingInput == 0) {
//		ImGuiIO& io = ImGui::GetIO();
//		io.ConfigFlags &= ~ImGuiConfigFlags_NavEnableKeyboard;
...
//void UIRenderer::AddKeyEvent(KeyEvent& a_keyEvent) {
//	WriteLocker locker(_inputEventLock);
//
//	_keyEventQueue.emplace_back(a_keyEvent);
//}

//void UIRenderer::OnFocusLost() {
//	_bFocusLost = true;
//}

//void UIRenderer::ProcessInputEventQueue() {
//	_lastKeyPressed = 0;
//
//	WriteLocker locker(_inputEventLock);
//
...
//void UIRenderer::DisplayWelcomeBanner() const {
//	static_cast<UIWelcomeBanner*>(_windows[static_cast<size_t>(WindowID::kWelcomeBanner)].get())->Display();
//}

////TODO Move to UITheme.cpp
//ImGuiStyle UIRenderer::GetStyle() {
//	ImGuiStyle style;
...
//void UIRenderer::UpdateStyle() {
//	
//}

//TODO MOVE TO UIWINDOW And Create a wrapper around it
